...
V = {
    ...
    'GALLERY_TITLE': 'Работы наших мастеров',
    'GALLERY_LEDE': 'Настоящие кадры с выездов, без стоковых фотографий в спецовках.',
    'GALLERY_NOTE': 'Каждое фото показывает либо неисправный узел, либо результат. '
                    'Если нужно фото вашей поломки до начала работ — скажите мастеру, сделает.',
}
